declare type Field = "main" | "module" | "browser" | "umd:main" | "exports";
export declare let errors: {
    ...
    missingBrowserConditionWithFieldPresent: string;
    missingBrowserFieldWithConditionPresent: string;
    noModuleFieldWithExportsField: string;
};
